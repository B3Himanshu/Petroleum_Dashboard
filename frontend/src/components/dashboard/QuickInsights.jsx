...
const InsightBadge = ({ label, active }) => (
  <button
    className={cn(
      "px-4 py-2 rounded-full text-sm sm:text-base font-medium transition-all",
      active
...
export const QuickInsights = () => {
  return (
    <div className="mb-6 animate-slide-up" style={{ animationDelay: "100ms" }}>
      <h3 className="text-base sm:text-lg font-semibold text-foreground mb-3">Quick Insights</h3>
